...
void LCD_ShowNum_back_black(u16 x,u16 y,u32 num,u8 len,u8 size);// back 黑 		point 白
void LCD_ShowNum_back_blue(u16 x,u16 y,u32 num,u8 len,u8 size); // back blue	point 黑
